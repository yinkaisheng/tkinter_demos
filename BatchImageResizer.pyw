...
class MainFrame(AsyncFrame, WidgetUtil):
    ...
    def convert_notify(self, thread_id: int, notify_id: int, args: Any):
    ...
    def convert_func(self, threadId: int, args: Any):
    ...
    def resize_image(self, src_path: int, src_ext: int, dst_path: int, dst_ext: int, clips: Tuple[int, int, int, int],
                     max_side: int = 1920, rotate: int = 0, flip_lr: bool = False, flip_rb: bool = False):
